    ...
    <section ref={sectionRef} className="bg-bg py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative h-[500px]">
          ...
          <div className="about-image-secondary absolute bottom-0 right-0 w-[55%] h-[55%] rounded-2xl overflow-hidden shadow-xl border-4 border-white">
            <Image
          ...
          <div className="about-image-secondary absolute top-10 right-10 w-[40%] h-[40%] rounded-2xl overflow-hidden shadow-xl border-4 border-white">
            <Image
